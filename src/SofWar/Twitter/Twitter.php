...
use SofWar\Twitter\Traits\AccountTrait;
use SofWar\Twitter\Traits\BlockTrait;
use SofWar\Twitter\Traits\DirectMessageTrait;
use SofWar\Twitter\Traits\FavoriteTrait;
use SofWar\Twitter\Traits\FriendshipTrait;
use SofWar\Twitter\Traits\GeoTrait;
use SofWar\Twitter\Traits\HelpTrait;
use SofWar\Twitter\Traits\ListTrait;
use SofWar\Twitter\Traits\MediaTrait;
use SofWar\Twitter\Traits\SearchTrait;
use SofWar\Twitter\Traits\StatusTrait;
use SofWar\Twitter\Traits\TrendTrait;
use SofWar\Twitter\Traits\UserTrait;
...
class Twitter extends tmhOAuth
{
    ...
    public function __construct(Config $config)
    {
        ...
        $this->debug = isset($this->tconfig['debug']) && $this->tconfig['debug'];
