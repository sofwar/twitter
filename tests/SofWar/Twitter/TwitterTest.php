...
class TwitterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->getMockBuilder('SofWar\Twitter\Twitter')
    ...
    {
        $twitter = $this->getTwitterExpecting('users/show', ['user_id' => 1234567890]);

        $twitter->getUsers(['user_id' => 1234567890]);
    }
    ...
    public function testGetUsersInvalid()
    {
        ...
        $twitter->getUsers(['include_entities' => true]);
    }

    public function testGetUsersLookupWithIds()
    {
        $twitter = $this->getTwitterExpecting('users/lookup', ['user_id' => '1,2,3,4']);

        $twitter->getUsersLookup(['user_id' => implode(',', [1, 2, 3, 4])]);
    }
    ...
    public function testGetUsersLookupInvalid()
    {
        ...
        $twitter->getUsersLookup(['include_entities' => true]);
    }
